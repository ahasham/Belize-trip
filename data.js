...
var DAYS = [
  ...
  {date:"Sat Apr 11",dn:2,title:"→ Belize → San Ignacio",loc:"San Ignacio",icon:"🌎",color:"#2D7D46",events:[
    ...
    {time:"7:00 PM",desc:"Dinner: Ko-Ox Han-Nah — 'let's go eat' in Mayan. Indian/Belizean/international. #5 Burns Ave",group:"ALL",type:"food"},
  ]},
...
var RESTS = {
  "San Ignacio":[
    {n:"Ko-Ox Han-Nah",d:"'Let's go eat' in Mayan · Indian curries, Belizean classics, huge portions · #5 Burns Ave · 4.5/5 TripAdvisor"},
    {n:"Running W Restaurant",d:"Award-winning steakhouse at hotel, ranch-sourced meats"},
  ],
  "Placencia":[
...
// ─── BELIZE FUN FACTS ───
var BZ_FACTS = [
  "🏛️ The tallest building in Belize is a Mayan temple — Caracol's Sky Palace at 141 ft. No modern building has surpassed it.",
  "🍔 There are zero McDonald's, Burger King, KFC, or Starbucks in all of Belize. The country has no major fast food chains.",
  "🐆 Belize has the world's only jaguar preserve — Cockscomb Basin Wildlife Sanctuary, home to all five of Belize's wild cats.",
  "🦎 Belize's national animal is the tapir — a 500-pound relative of horses and rhinos nicknamed the 'mountain cow.'",
  "🌊 Belize's Barrier Reef is the 2nd largest in the world (190 miles) and a UNESCO World Heritage Site.",
  "🕳️ The Great Blue Hole is a 400-ft deep underwater sinkhole visible from space. Jacques Cousteau named it a top dive site.",
  "🐀 The national dish is 'gibnut' — a large rodent nicknamed 'royal rat' after it was served to Queen Elizabeth II in 1985.",
  "👹 Belizean folklore features Tata Duende, a thumbless forest dwarf who steals children's thumbs if they misbehave in the jungle.",
  "🏝️ Belize has 450+ islands called 'cayes' (pronounced keys). Each has a government-appointed watchman.",
  "🗣️ Belize is the only Central American country where English is the official language — but everyone speaks Kriol.",
  "🍫 The ancient Maya in Belize were among the first to cultivate cacao. They used cocoa beans as currency around 600 BC.",
  "🧜‍♀️ According to Belizean superstition, swimming on Good Friday will turn you into a mermaid.",
  "🌺 The national flower is the Black Orchid — one of 500+ orchid species found in Belize's rainforests.",
  "🦜 The national bird is the Keel-Billed Toucan, known for its rainbow-colored bill.",
  "💵 Belize's currency is perfectly pegged: 2 BZD = 1 USD, always. Makes math easy!",
  "🌳 Over 60% of Belize is covered in forest — the highest rate in Central America.",
  "🏃 Placencia has the narrowest main street in the world — a 4-foot-wide sidewalk running through the village.",
  "⚽ Belize's motto is 'Sub Umbra Floreo' — Latin for 'Under the shade I flourish.'",
  "🦈 Whale sharks gather at Gladden Spit during full moons from March to June.",
  "🏗️ The capital moved from Belize City to Belmopan in 1970 after Hurricane Hattie devastated the coast in 1961.",
];
